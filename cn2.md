...
###Werkwijze
####Personeel voorbeeld
1. hosts: Minimaal 500 hosts -> 2^8? = 256 Niet genoeg -> 2^9 = **512 hosts (waarvan 2 voor netwerk- en subadres: 510)** 
...
1. hosts: Minimaal 20 hosts -> 2^5 = **32 hosts (waarvan 2 voor netwerk- en subadres: 30)**
2. CIDR: 32b – het aantal bits  genomen voor de hosts te bepalen. 
...
####Directie voorbeeld
1. hosts: 10 hosts nodig, dus 2^4 = **16 hosts (waarvan 2 voor netwerk- en subadres: 14)**
2. CIDR:  **32 - 4 -> /28**
